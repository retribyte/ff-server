...
const initializeSeasonRoutes = (): Router => {
    ...
    // GET /api/seasons: Return all seasons with their episodes
    ...
    // GET /api/seasons/:title: Return a season by title with its episodes
    ...
    router.put("/seasons/:title", authenticate, async (req: Request, res: Response) => {
        const { title } = req.params;
    ...
    router.delete("/seasons/:title", authenticate, async (req: Request, res: Response) => {
        const { title } = req.params;
        try {
