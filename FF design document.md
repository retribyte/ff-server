...
- **FR-CHAR-4** A character MUST be able to record interpersonal relationships to other characters (per the `Relationship` model in §4.4 — planned, not yet implemented).
